...
private:
    ...
    // Use try_lock with timeout in audio thread to prevent latency spikes
    mutable std::mutex dataLock;
    static constexpr std::chrono::microseconds lockTimeoutUs{100}; // 100 microseconds max wait
