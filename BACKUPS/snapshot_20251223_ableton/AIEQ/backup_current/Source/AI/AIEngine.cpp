    ...
    float minConfidence) const
{
    ...
    for (const auto& c : pendingCorrections)
    {
        ...
        float typeMinSeverity = minSeverity;
        float typeMinConfidence = minConfidence;
        ...
        switch (c.type)
        {
            ...
            case ProblemType::Harshness:
            case ProblemType::Sibilance:
                // Critical problems: slightly lower thresholds
                typeMinSeverity = minSeverity * 0.8f;
                typeMinConfidence = minConfidence * 0.9f;
                break;
                
            case ProblemType::ThinSound:
            case ProblemType::DullSound:
                // Subtle problems: higher thresholds (less reliable)
                typeMinSeverity = minSeverity * 1.2f;
                typeMinConfidence = minConfidence * 1.1f;
                break;
        ...
        if (c.severity >= typeMinSeverity && c.confidence >= typeMinConfidence)
        {
