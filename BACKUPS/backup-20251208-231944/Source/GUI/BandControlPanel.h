...
public:
        ...
        : bandIndex(bandIdx), parameters(apvts)
    {
        ...
        freqLabel.setFont(juce::Font(juce::FontOptions().withHeight(8.0f)));
        ...
        gainLabel.setFont(juce::Font(juce::FontOptions().withHeight(8.0f)));
        ...
        qLabel.setFont(juce::Font(juce::FontOptions().withHeight(8.0f)));
        ...
        typeLabel.setFont(juce::Font(juce::FontOptions().withHeight(8.0f)));
