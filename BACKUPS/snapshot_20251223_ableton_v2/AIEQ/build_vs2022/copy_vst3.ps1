if (Test-Path "C:/AIEQ/build_vs2022/AIEqualizerPro_artefacts/Release/VST3/AI Equalizer Pro.vst3") {
    # Fix: Ensure DLL is in the correct location within the bundle
    $dllSource = "C:/AIEQ/build_vs2022/Release/lib/AI Equalizer Pro.vst3"
    $dllDest = "C:/AIEQ/build_vs2022/AIEqualizerPro_artefacts/Release/VST3/AI Equalizer Pro.vst3\Contents\x86_64-win64\AI Equalizer Pro.vst3"
    ...
    Copy-Item -Path "C:/AIEQ/build_vs2022/AIEqualizerPro_artefacts/Release/VST3/AI Equalizer Pro.vst3" -Destination "$destPath" -Recurse -Force
    ...
    try {
        ...
        Copy-Item -Path "C:/AIEQ/build_vs2022/AIEqualizerPro_artefacts/Release/VST3/AI Equalizer Pro.vst3" -Destination "$systemPath" -Recurse -Force -ErrorAction Stop
    ...
    Write-Host "[ERRORE] Plugin non trovato in: C:/AIEQ/build_vs2022/AIEqualizerPro_artefacts/Release/VST3/AI Equalizer Pro.vst3"
    exit 1
}
