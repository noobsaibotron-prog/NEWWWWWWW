...
public:
        ...
        : semanticEngine(engine)
    {
        ...
        subtitleLabel.setFont(juce::Font(10.0f, juce::Font::italic));
        ...
        commandInput.setFont(juce::Font(12.0f));
        ...
        intensityLabel.setFont(juce::Font(9.0f, juce::Font::bold));
...
private:
                           ...
                           const juce::String& tooltip)
    {
        ...
        data.label.setFont(juce::Font(10.0f, juce::Font::bold));
