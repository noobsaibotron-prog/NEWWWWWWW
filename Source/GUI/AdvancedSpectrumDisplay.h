...
private:
    ...
    void renderSpectrumToImage()
    {
        ...
        {
            // Pass 1: soft dusty-azure fill gradient
        ...
        {
            // Pass 1: thin luminous cyan fill gradient (deliberately
            // lower alpha than pre-EQ so the two layers cooperate
            // instead of piling into a milky wall).
