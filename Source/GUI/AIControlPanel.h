...
public:
    ...
    explicit AIControlPanel(AIEqualizerAudioProcessor& p) : processor(p)
    {
        ...
        aiLabel.setFont(juce::Font(12.0f, juce::Font::bold));
        ...
        genreLabel.setFont(juce::Font(9.0f));
        ...
        genreValue.setFont(juce::Font(11.0f, juce::Font::bold));
        ...
        problemsLabel.setFont(juce::Font(10.0f, juce::Font::bold));
    ...
    void drawProblems(juce::Graphics& g)
    {
        ...
        if (corrections.size() > 6)
        {
            ...
            g.drawText("+" + juce::String(corrections.size() - 6) + " more",
                      bounds.getX(), y, bounds.getWidth(), 14, juce::Justification::centred);
        }
    }
